...
def go(args):
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Random Forest model exported with pipeline",
        metadata=rf_config
    )

    # Add the saved model directory
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    non_ordinal_categorical_preproc =non_ordinal_categorical_preproc = Pipeline([
    ...
    sk_pipe = Pipeline([
    ("preprocessor", preprocessor),  # your ColumnTransformer instance
    ("random_forest", random_Forest)  # your RandomForest model instance
    ])
