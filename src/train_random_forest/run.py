...
def go(args):
    ...
    categorical_cols = ordinal_categorical + non_ordinal_categorical
        
    X_val[categorical_cols] = X_val[categorical_cols].astype('string')'''
    ...
    logger.info("Uploading feature importance viz")
    run.log(
        {
