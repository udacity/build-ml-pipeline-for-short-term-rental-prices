...
def go(args):
    ...
    # The directory (random_forest_dir) needs to be recreated before saving the model
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Regression pipeline export",
        metadata=rf_config
    )
    artifact.add_dir(export_path) #add the "random_forest_dir" directory to the artifact

    run.log_artifact(artifact) #log artifact to the run
